...
?>
	...
	&nbsp &nbsp Email:<?php echo $row['email'];?><br>
	&nbsp &nbsp Comments:<?php echo $row['comment'];?>	
	<hr>
...
<button class="button button3"style="vertical-align:middle"><span>Back</span></button>
</center>
</body>
</div></div></div></div></div>
</html>
