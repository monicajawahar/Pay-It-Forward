...
<?php
	...
	$result="select * from userdetials where username='".$n."'";
	$del=mysql_query($result,$connect);
	while($row=mysql_fetch_array($del,MYSQL_ASSOC))
	{
...
<br>
Mobile:<?php echo $row['contactnumber']; ?>
<br>
...
<form action="delete3.php" method="POST">
	<input type="hidden" name="del" value="<?php echo $n;?>"hidden >
